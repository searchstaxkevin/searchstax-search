		...
		<div class="searchstax_search_option_frame">
			...
			<form method="post" action="options.php">
				...
				<div id="searchstax_search_account" class="searchstax_search_tab">
					...
					<div>
						<h3>Search UI Kit</h3>
						<p>Search UI Kit tokens, endpoints, and configuration</p>
					</div>
					<div>
						<h4>Suggest API URL</h4>
						<input type="text" name="searchstax_search_searchui_suggest_url" value="<?php echo esc_attr( get_option('searchstax_search_searchui_suggest_url') ); ?>" size=50 />
					</div>
					<div>
						<h4>Related Searches Token</h4>
						<input type="text" name="searchstax_search_searchui_related_token" value="<?php echo esc_attr( get_option('searchstax_search_searchui_related_token') ); ?>" size=50 />
					</div>
					<div>
						<h4>Related Searches API URL</h4>
						<input type="text" name="searchstax_search_searchui_related_url" value="<?php echo esc_attr( get_option('searchstax_search_searchui_related_url') ); ?>" size=50 />
					</div>
					<div>
						<h4>Smart Answers API URL</h4>
						<input type="text" name="searchstax_search_searchui_smart_url" value="<?php echo esc_attr( get_option('searchstax_search_searchui_smart_url') ); ?>" size=50 />
					</div>
					<div>
						<h4>Analytics Tracking Token</h4>
						<input type="text" name="searchstax_search_searchui_analytics_token" value="<?php echo esc_attr( get_option('searchstax_search_searchui_analytics_token') ); ?>" size=50 />
					</div>
					<div>
						<h4>App ID</h4>
						<input type="text" name="searchstax_search_searchui_app_id" value="<?php echo esc_attr( get_option('searchstax_search_searchui_app_id') ); ?>" size=50 />
					</div>
					<?php submit_button(); ?>
				</div>
